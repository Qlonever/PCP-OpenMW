...
-- Variables included in interface:
    ...
    -- levelUps ................. The number of levels the player has gained with this mod, generally one less than player level unless installed mid-playthrough
    ...
    -- attributeData ............ Data tables containing variables for each attribute, accessible by attribute record IDs
        -- ups ...................... The total value the attribute has been increased by this mod
        -- potential ................ The potential of the attribute, stored as a number of points over the attribute's base value rather than the actual limit visible in the menu
    -- skillData ................ Data tables containing variables for each skill, accessible by skill record IDs
        -- ups ...................... The total value the skill has been increased by while this mod was installed, currently unused but still tracked
...
-- Interface functions:
    ...
    -- set(key, value) .......................... Sets the variable with the given key equal to the given value
    -- inc(key, value) .......................... Adds the value to the variable with the given key, returns the incremented value
    ...
    -- attributeInc(attributeId, key, value) .... Adds the value to the attribute's variable with the given key, returns the incremented value
    -- attributeSetAll(key, value) .............. Sets the variable with the given key equal to the value for every attribute
    -- attributeIncAll(key, value) .............. Adds the value to the variable with the given key for every attribute
    ...
    -- skillInc(skillId, key, value) ............ Adds the value to the skill's variable with the given key, returns the incremented value
    -- skillSetAll(key, value) .................. Sets the variable with the given key equal to the value for every skill
    -- skillIncAll(key, value) .................. Adds the value to the variable with the given key for every skill
